...
QUERY       : EXPRESSION {$$ = createQuery($1); char *result=get_jsquery($$); exit(0); }
            ;
...
TEXT_CLAUSE : LSCOPE TEXT_OPERATOR EQ LSCOPE SEARCH_OPERATOR EQ STRING RSCOPE RSCOPE { $$ = createTextClause($7, false, "", false, false); }
